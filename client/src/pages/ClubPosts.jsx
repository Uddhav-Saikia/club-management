...
const ClubPosts = () => {
    ...
    const fetchAdminPosts = async () => {
      ...
      try {
        const response = await fetch(
          `/api/admin/get/adminPosts/${adminID}`,
          {
            headers: {
        ...
        if (data.posts && data.posts.length > 0) {
          ...
          setPost([
            { srno: 1, postId: '1', title: 'Photography Workshop', date: '2025-08-01', clubName: 'Photography Club' },
            { srno: 2, postId: '2', title: 'Robotics Bootcamp', date: '2025-08-05', clubName: 'Robotics Club' },
            { srno: 3, postId: '3', title: 'Music Jam', date: '2025-08-10', clubName: 'Music Club' },
            { srno: 4, postId: '4', title: 'Drama Night', date: '2025-08-15', clubName: 'Drama Club' },
            { srno: 5, postId: '5', title: 'Hackathon', date: '2025-08-20', clubName: 'Coding Club' },
          ]);
        }
        setIsLoading(true);
      } catch (error) {
  ...
  const deleteClubPost = async (postId) => {
    ...
    try {
      const response = await fetch(
        `/api/admin/delete/clubPosts/${postId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
